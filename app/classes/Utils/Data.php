...
class Data
{
    ...
    public function convertTimeToDate($params, $time)
    {
        return date($params, strtotime($time));
        //return date('F d, Y h:i:s A', strtotime($time));
    }
    ...
    public function randBytes($length): string
    {
    ...
    public function randMemberId(): string
    {
    ...
    public function statusToText(int $status, bool $color = false): string
    {
        if ($color) {
            switch ($status) {
                case 0:
