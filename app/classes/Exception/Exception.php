...
class Exception extends \ErrorException
{
    ...
    public function handler($exception)
    {
        ...
        echo '<link rel="stylesheet" type="text/css" href="/Resources/jQuery/Addons/Bootstrap/v4.5.2/css/bootstrap.css" media="all">';
        ...
        echo '<div class="col-md-12 tac f_26 b_i">Fatal Core Exception</div>';
        echo '</div>';
