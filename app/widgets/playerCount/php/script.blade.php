...
<div>
    ...
    <p>aol percent: {{$aolPercent}} %</p>
    <p>uof percent: {{$uofPercent}} %</p> --}}

    <div class="progress-bar-container">
        @if ($aolPercent == '0')
            <p class="factionPercent">AoL:</p><div class="progress-bar-panel progress-blue" style="width:20%">
                <span class="percent">{{$aolPercent}}%</span>
            </div>
            <br>
            <p class="factionPercent">UoF:</p><div class="progress-bar-panel progress-red" style="width:20%">
                <span class="percent">{{$uofPercent}}%</span>
            </div>
        @else
            <p class="factionPercent">AoL:</p><div class="progress-bar-panel progress-blue" style="width:{{$aolPercent}}%">
                <span class="percent">{{$aolPercent}}%</span>
            </div>
            <br>
            <p class="factionPercent">UoF:</p><div class="progress-bar-panel progress-red" style="width:{{$uofPercent}}%">
                <span class="percent">{{$uofPercent}}%</span>
            </div>
        @endif
    </div>
