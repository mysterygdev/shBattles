...
class Bootstrap
{
    ...
    private function init()
    {
        ...
        define("CFG_PATH",ROOT_PATH.'../Config'.DS);
        ...
        define('CONFIGS_PATH',FRAMEWORK_PATH.'configs'.DS);
...
//            Loader::__load(CONFIGS_PATH,'config',$allowed_configs,true);
//            die;
            $this->loadConfigs();
...
#        Loader::__load(CONFIG_PATH,'config',$allowed_configs);
    }
