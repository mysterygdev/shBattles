...
<form class="edit">
   <h4>Editing: <?php echo e($Column); ?></h4>
   <br>
      ...
      <div class="form-group row">
        ...
        <div class="form-inline">
           <div class="input-group mb-3 youplay-input">
               <input type="text" id="Value" name="Value"placeholder="New Value" value="<?php echo e($Value); ?>">
            </div>
        </div>
      </div>
      <div class="row">
...
<?php /**PATH C:\laragon\www\shaiyabattles\public\resources\jquery\addons\ajax\site\user/details_edit.blade.php ENDPATH**/ ?>