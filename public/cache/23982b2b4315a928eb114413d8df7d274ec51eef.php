        ...
        <?php if(count($data['news']->getNews()) > 0): ?>
          <?php $__currentLoopData = $data['news']->getNews(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row">
              ...
              <span class="float-left"><?php echo e($res->Author); ?></span>
...
<?php echo $__env->make('layouts.cms.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\originals\resources\views/pages/cms/community/news.blade.php ENDPATH**/ ?>