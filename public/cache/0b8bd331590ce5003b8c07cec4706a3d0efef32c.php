<?php $__env->startSection('index', 'manageTierRewards'); ?>
...
<?php $__env->startSection('content'); ?>
                              ...
                              <tbody>
                                <?php $__currentLoopData = $data['rewards']->getRewards(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <tr>
                                    ...
                                    <td><?php echo e($fet->RewardName); ?></td>
                                    <td><?php echo e($fet->RewardDesc); ?></td>
                                    <td><?php echo e($fet->RewardImage); ?></td>
                                    <td><?php echo e($fet->Tier); ?></td>
                                    <td><button type="button" class="btn btn-sm btn-primary" name="submit" onclick="window.open('/admin/site/tieredSpender/editReward/<?php echo e($fet->RowID); ?>','_target')">Edit</button></td>
                                    <td><button type="submit" class="btn btn-sm btn-danger open_mTR_rmv_modal" data-toggle="modal" data-id="<?php echo e($fet->RowID); ?>~<?php echo e($fet->RewardName); ?>~<?php echo e($fet->RewardDesc); ?>~<?php echo e($fet->RewardImage); ?>~<?php echo e($fet->Tier); ?>" data-target="#get_mTR_rmv_modal">Remove</button></td>
                                  </tr>
  ...
  <?php echo e(display('get_mTR_rmv_modal','','0','2','Confirm Reward Removal')); ?>
...
<?php echo $__env->make('layouts.ap.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\shaiyabattles\resources\views/pages/ap/site/tieredSpender/manageRewards.blade.php ENDPATH**/ ?>