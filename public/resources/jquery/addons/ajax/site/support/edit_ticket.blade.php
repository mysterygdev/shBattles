...
<div class="container">
	@php
		$data['support']->editTicket($UserUID,$TicketID);
		#var_dump($data['user']->getUserGameInfo(5, 'UserID'));
		#die();
		#var_dump($data);
		#{{$data->getTickets();}}
	@endphp
	@foreach($data['support']->row as $tickets)
	{{-- {{var_dump($tickets)}} --}}
		@if($tickets->Type == '0')
			<div class="row">
				<div class="col-md-6 col-md-offset-1 badge-pill badge-primary mt1p">
		...
		@elseif($tickets->Type == '1')
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-6 col-md-offset-1 badge-pill badge-secondary mt1p">
