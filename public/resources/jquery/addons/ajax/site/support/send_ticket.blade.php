<?php
  $UserUID	=	$_POST['id'] ? trim($_POST["id"])		:	false;
?>
<form class="send_ticket" method="POST">
	...
	<div class="row m_b_10">
		...
		<div class="col-md-6">
			<button type="button" class="btn gradient color-white text-center" id="send_ticket_submit">Send <i class="fa fa-send"></i></button>
		</div>
	</div>
</form>
<script>
